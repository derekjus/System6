...
$("a[data-rel=SSC]").click(function(e) {
    e.preventDefault();
    $(this.hash).fadeOut(400, function() {
		$(this).css({ top: top, left: left });
	});
});

$("a[data-rel=SSS]").click(function(e) {
    e.preventDefault();
    	$(this).addClass('bounce').delay(1600).queue(function() { $(this).removeClass('bounce'); $(this).append(item); item.fadeIn(500); $(this).dequeue(); });
    $(this.hash).delay(1630).queue(function() { $(this).show(); $(this).dequeue(); });
});
